...
<div id="content">
	<div class="menu-trigger"></div>
        <div class="indexMsg">
            <img class="logoMenu" src="src/logo.png" width="300px" height="200px"/>
            <p class="typewriter">Êtes vous sûr de vouloir vous déconnecter ?</p>
            <a href="PHP/disconnect.php" class="butn">Se déconnecter</a>
        </div>
</div>
